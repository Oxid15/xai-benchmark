...
from ...utils import ChannelDataloader, batch_gini, minmax_normalize
...
class Sparsity(Metric):
    ...
    **The greater the better**
    ...
    def __init__(
        self, ds: Dataset, model: Model, expl: Explainer, *args: Any, **kwargs: Any
    ) -> None:
        super().__init__(
            name="sparsity", direction="up", ds=ds, model=model, explainer=expl, *args, **kwargs
        )
